...
class DatabaseApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.load_button = QPushButton("Load Data")  # Add Load Data button
        ...
        self.sell_button.clicked.connect(self.handle_sell_request)

        
        self.load_button.clicked.connect(self.load_data)  # Connect Load Data button to load_data
    ...
    def load_data(self):
        ...
        self.table_widget.setColumnCount(25)
    ...
    def handle_sell_request(self):
        selected_row = self.table_widget.currentRow()
        if selected_row >= 0:
            self.sell_signal.emit(selected_row)  # Emit the custom signal to handle the sale
    ...
    def sell_selected_row(self):
     ...
     if selected_row >= 0:
        ...
        selected_row_data = [self.table_widget.item(selected_row, col).text() for col in range(25)]  # Extract all column values
        
        # Insert the row into 'sales' table in 'sales_manager.db'
